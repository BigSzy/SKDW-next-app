        ...
        <section className={styles.sectionWrapper}>
            <div className='container'>
                <div className={styles.lead}>
                    ...
                    <h3 className={playfairDisplay.className}>Having a new found passion in front-end development i always push the boundries of my knowledge with each project, making them look and work better each time. I take the upmost pride in my work and will not deliver projects that are up to industry standards.</h3>
                </div>
